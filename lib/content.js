...
const en = {
  ...
  science: {
    ...
    research: {
      ...
      entries: {
        mlp: {
          // The paper is published in French only, so its title stays in French
          // verbatim in both locales — a citation, not translatable UI copy.
          title:
