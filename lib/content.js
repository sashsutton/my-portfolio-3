...
export const shared = {
   ...
   */
  portrait: { src: null, width: 1000, height: 1250 },
   ...
   * platter. See components/three/vinyl/useTurntableAudio.js.
   * TODO: drop files in public/audio/ and fill these in.
   */
  tracks: [
...
const en = {
  ...
  music: {
    ...
    play: "Play",
    pause: "Pause",
    embedNote: "// SoundCloud / Bandcamp embeds go here",
    credits: {
      title: "Credentials",
      items: [
...
const fr = {
  ...
  music: {
    ...
    play: "Lecture",
    pause: "Pause",
    embedNote: "// intégrations SoundCloud / Bandcamp ici",
    credits: {
      title: "Parcours",
      items: [
