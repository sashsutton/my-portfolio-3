...
const en = {
  ...
  music: {
    ...
    sets: {
      ...
      dj: "DJ set",
      live: "Live set",
      video: "Live set — video",
      // Shown until a file lands at public/audio/live-set.mp3.
      livePlaceholder: "self-hosted set goes here",
    },
...
const fr = {
  ...
  music: {
    ...
    sets: {
      ...
      dj: "DJ set",
      live: "Live set",
      video: "Live set — vidéo",
      livePlaceholder: "le set auto-hébergé ira ici",
    },
    spin: "faire tourner",
